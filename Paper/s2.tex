...
wave function to be spin pure. As expected, for the same energy the number of
determinants is increased when spin purity is imposed. Then, we have run the
CIPSI selection for the $m_s=0$ wave function imposing the
spin purity. The convergence of the energy is plotted as a function of the
number of determinants in figure~\ref{fig:e_var_ndet}, and as a function of
the number of \sop{} in figure~\ref{fig:e_var_nsop}.
From figure~\ref{fig:e_var_nsop}, it is striking that the $m_s=0$ and $m_s=6$
...
2018-A0040801738). KG acknowledges support from grant number CHE1762337 from the U.S. National Science Foundation.
\end{acknowledgments}
