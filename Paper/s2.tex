...
A \emph{space occupation pattern} (\sop) is a vector of occupation numbers
of molecular orbitals. For example, the \sop{} $(2,1,1,1,1)$ is made of two \csf s
and $6$ different Slater determinants:
\begin{align}
...
spin coupling coefficients are included in the CI expansion, the truncated wave
function is also an eigenfunction of $\stwo$.
...
% CSF     16: C(  1)=-0.577350 :  -4 -3  2  1
%             C(  2)= 0.288675 :   4 -3 -2  1
%             C(  3)= 0.288675 :  -4  3 -2  1
%             C(  4)= 0.288675 :   4 -3  2 -1
%             C(  5)= 0.288675 :  -4  3  2 -1
%             C(  6)=-0.577350 :   4  3 -2 -1
                                    
% CSF     21: C(  1)= 0.500000 :   4 -3 -2  1
%             C(  2)=-0.500000 :  -4  3 -2  1
%             C(  3)=-0.500000 :   4 -3  2 -1
%             C(  4)= 0.500000 :  -4  3  2 -1
